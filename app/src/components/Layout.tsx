...
const DemoDisclosure = () => (
    <div className="border-b border-border/40 bg-background/72 backdrop-blur-xl">
        <div className="container flex flex-col gap-2 py-2.5 text-xs text-foreground/85 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-start gap-2">
                <span className="mt-0.5 inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary shadow-[0_0_18px_hsl(var(--primary)/0.22)]">
