    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="surface-elevated overflow-hidden border-border-strong p-0 sm:max-w-md">
                <div className="h-1 bg-gradient-ember" />
                <div className="p-6">
                    <DialogHeader>
                    ...
                    <div className="py-6 flex flex-col items-center text-center gap-4">
                        ...
                        <div className="w-full rounded-2xl border border-border bg-background-secondary/60 p-4 text-left text-xs">
                        ...
                        <div className="w-full rounded-xl border border-info/20 bg-info/10 p-3 text-left text-xs text-foreground/80">
                        ...
                        <div className="flex w-full items-center justify-between rounded-xl border border-border bg-card/50 px-3 py-2 text-xs text-muted-foreground">
