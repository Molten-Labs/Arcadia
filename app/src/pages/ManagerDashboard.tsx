      ...
      <div className="container py-10">
        <div className="flex flex-wrap justify-between gap-4 items-end mb-8">
          <div>
            ...
            <h1 className="font-display type-h1 font-semibold">Arcadia manager</h1>
        ...
        {isLoading ? (
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-4">
              ...
              {myVaults.map(v => (
                <Link key={v.id} to={`/manager/vault/${v.id}`} className="surface rounded-lg p-5 block hover:border-border-strong">
            ...
            <div className="space-y-6">
              ...
              {paperVault && (
                <div className="surface rounded-lg p-6 border-primary/30">
