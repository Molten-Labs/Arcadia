    ...
    <div className="min-h-screen" style={{ background: "var(--color-bg)" }}>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
            ...
            <tbody>
              {TX_HISTORY.map((row, i) => (
                ...
                >
                  ...
                  <td className="py-3 px-4 font-mono" style={{ color: "var(--color-purple-bright)" }}>
                    {row.sig !== "—" ? (
        ...
        >
          ...
          <code className="font-mono" style={{ color: "var(--color-purple-bright)" }}>process_withdraw()</code> becomes available.
        </div>
      </div>
    </div>
  );
